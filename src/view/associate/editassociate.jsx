...
const AddAssociate = () => {
    ...
    const handleFormSubmit = (values, onSubmitProps) => {
        const formData = new FormData();
        formData.append('add-associate', user.editid);
    ...
    const getAssociateDetails = () => {
        const formData = new FormData();
        formData.append('associate-details', user.editid);
        setLoading(true);
        axios.post('/real_state_api/admin/index', formData)
            .then(function (response) {
                if (response.data.status) {
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
                                        ...
                                        <Box sx={{ display: "flex", gap: "20px", flexDirection: { xs: "column-reverse", md: "row" }, alignItems: "center" }}>
                                            ...
                                            <Paper sx={{ display: "flex", justifyContent: 'center', flexDirection: "column", alignItems: "center", width: "150px", height: "220px" }}>
                                                <Avatar alt="Profile" src={file.file === null ? "/real_state_api/assets/associate-photos/" + user.editid + ".png" : file.image}
                                                    sx={{
                                                        width: "150px",
                                                        height: "180px",
                                                        marginBottom: "0px",
                                        ...
                                        <Box sx={{ display: "flex", justifyContent: "center", gap: "80px" }}>
                                            <Button
                                                ...
                                                sx={{ margin: "20px 0px" }}
                                                variant="contained"
                                            >Update Associate's Profile</Button>
                                        </Box>
                                    </Box>
                                </Box>
                            </form>
...
const checkoutSchema = yup.object().shape({
    ...
    bank_ac_no: yup.string().required("Required"),
