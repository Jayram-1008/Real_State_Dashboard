...
const AddAssociate = (props) => {
    ...
    const searchAssociateId = async (sponsor_id) => {
        try {
            const formData = new FormData();
            formData.append('associate-details', sponsor_id);
            var requestOptions = {
                method: 'POST',
                body: formData,
            };
            const response = await fetch('/real_state_api/admin/index', requestOptions);
            const data = await response.json();
            return data;
        } catch (error) {
    ...
    const debouncedSearchAssociateId = debounce(searchAssociateId, 2000);
    ...
    const handleFormSubmit = (values, onSubmitProps) => {
        const formData = new FormData();
        formData.append('add-associate', "");
        formData.append('category', values.category);
        formData.append('branch', values.branch);
        formData.append('sponsorcode', values.sponsor_code);
        ...
        formData.append('localaddress', values.local_addrsss);
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
                                            ...
                                            <Box sx={{ width: "100%", display: "flex", flexDirection: "column", gap: "20px", }}>
                                                ...
                                                >
                                                    <TextField
                                                        ...
                                                        onChange={(e) => {
                                                            handleChange(e);
                                                            debouncedSearchAssociateId(e.target.value)
                                                                .then((data) => {
                                                                    if (data.status) {
                                                        ...
                                                        name="sponsor_code"
                                                        error={!!touched.sponsor_code && !!errors.sponsor_code}
                                                        helperText={touched.sponsor_code && errors.sponsor_code}
                                                    />
                                                ...
                                                <TextField
                                                    ...
                                                    onBlur={handleBlur}
                                                    onChange={handleChange}
                                                    value={values.permanent_addrsss}
                                                    name="permanent_addrsss"
                                                    error={!!touched.permanent_addrsss && !!errors.permanent_addrsss}
                                                    helperText={touched.permanent_addrsss && errors.permanent_addrsss}
                                                />
                                            </Box>
                                        ...
                                        <Box sx={{ display: "flex", gap: "20px", flexDirection: { xs: "column", sm: "row" } }}>
                                            ...
                                            <TextField
                                                ...
                                                onBlur={handleBlur}
                                                onChange={handleChange}
                                                value={values.local_addrsss}
                                                name="local_addrsss"
                                                error={!!touched.local_addrsss && !!errors.local_addrsss}
                                                helperText={touched.local_addrsss && errors.local_addrsss}
                                            />
                                        </Box>
                                        <Box sx={{ display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
...
const checkoutSchema = yup.object().shape({
    ...
    permanent_addrsss: yup.string().required("Required"),
    ...
    local_addrsss: yup.string(),
    bank_acc_no: yup.string().required("Required"),
    bank_name: yup.string().required("Required"),
    bank_ifsc: yup.string().required("Required"),
